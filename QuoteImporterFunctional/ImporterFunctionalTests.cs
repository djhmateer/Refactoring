...
namespace QuoteImporterFunctional
{
    public class ImporterFunctionalTests
    {
        ...
        {
            var result = ImporterFunctional.ReadFileListOfLines();
        ...
        {
            // mocking out RunQuoteImporter's 4 dependencies
            ...
            Action run = () => ImporterFunctional.RunQuoteImporter(log,
        ...
        //    ImporterFunctional.RunQuoteImporter(log, getCustomers, createReport, sendEmail);
